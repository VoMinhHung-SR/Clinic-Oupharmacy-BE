...
urlpatterns = [
    ...
    re_path(
        r'^(?!products|categories|brands|shipping-methods|payment-methods|orders|order-items|medicine-batches|notifications|dynamic-filters|search-terms)(?P<category_slug>[\w\-/]+)/?$', 
